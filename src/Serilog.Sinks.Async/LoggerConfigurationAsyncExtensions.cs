...
namespace Serilog
{
    ...
    public static class LoggerConfigurationAsyncExtensions
    {
        ...
        /// <returns>A <see cref="LoggerConfiguration"/> allowing configuration to continue.</returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static LoggerConfiguration AsyncChannel(
            this LoggerSinkConfiguration loggerSinkConfiguration,
            Action<LoggerSinkConfiguration> configure,
            int bufferSize)
        {
            return loggerSinkConfiguration.AsyncChannel(configure, bufferSize, false);
        }
        ...
        public static LoggerConfiguration AsyncChannel(
            ...
            bool blockWhenFull = false)
        {
            return loggerSinkConfiguration.AsyncChannel(configure, null, bufferSize, blockWhenFull);
        }
            ...
            bool blockWhenFull = false)
        {
            return LoggerSinkConfiguration.Wrap(
                loggerSinkConfiguration,
                wrappedSink => new ChannelSink(wrappedSink, bufferSize, blockWhenFull, monitor),
                configure,
                LevelAlias.Minimum,
                null);
        }
        ...
        /// <returns>A <see cref="LoggerConfiguration"/> allowing configuration to continue.</returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static LoggerConfiguration AsyncImmutable(
            this LoggerSinkConfiguration loggerSinkConfiguration,
            Action<LoggerSinkConfiguration> configure,
            int bufferSize)
        {
            return loggerSinkConfiguration.AsyncImmutable(configure, bufferSize, false);
        }
        ...
        public static LoggerConfiguration AsyncImmutable(
            ...
            bool blockWhenFull = false)
        {
            return loggerSinkConfiguration.AsyncImmutable(configure, null, bufferSize, blockWhenFull);
        }
            ...
            bool blockWhenFull = false)
        {
            return LoggerSinkConfiguration.Wrap(
                loggerSinkConfiguration,
                wrappedSink => new ImmutableAsyncSink(wrappedSink, bufferSize, blockWhenFull, monitor),
                configure,
                LevelAlias.Minimum,
                null);
        }
